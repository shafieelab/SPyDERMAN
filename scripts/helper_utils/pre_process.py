...
def image_train(resize_size=224, crop_size=224, alexnet=False):
    # if not alexnet:
    #normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
    normalize = transforms.Normalize(mean=[0.23648548, 0.22770461, 0.21922055], std=[0.22075148, 0.215683, 0.20835723])
    # else:
...
def image_test(resize_size=224, crop_size=224, alexnet=False):
    # if not alexnet:
    #normalize = transforms.Normalize(mean=[0.23648548, 0.22770461, 0.21922055], std=[0.22075148, 0.215683, 0.20835723])
    # else:
    #   normalize = Normalize(meanfile='./ilsvrc_2012_mean.npy')
