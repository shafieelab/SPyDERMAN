...
Images = []
images_path = "E:/PEOPLE files/Deeksha/Bubble Project/Data/Sim_Tile"
print(images_path)
...
class dataGenerator(object):
    ...
    def get_batch(self, amount):
        ...
        # print (idx)
        for i in fil:
            temp1 = Image.open(images_path + '/' + i)
            temp2 = temp1.resize((256, 256))

            # temp = np.array(temp2.convert('RGB'), dtype='float32')
            temp = np.array(temp2.convert('RGB'), dtype='float32') / 255
...
class WGAN(object):
    ...
    def train_dis(self):
        ...
        # print(d_loss)
        with open('loss_values_d.csv', mode='a') as file:
            csv_writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

            csv_writer.writerow(
                [str(self.GAN.steps),d_loss])
        return d_loss
    ...
    def train_gen(self):
        ...
        # print(g_loss)
        with open('loss_values_g.csv', mode='a') as file:
            csv_writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

            csv_writer.writerow(
                [str(self.GAN.steps),g_loss])
        return g_loss
